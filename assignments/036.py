...
# containing only the numbers within the range [min_val, max_val]
#  (inclusive). For example, filter_range([1, 5, 3, 8, 2], 2, 5)
#  returns [5, 3, 2]. Use list methods like append() and loops with conditionals.
